...
const renderCards = (clickedOption) => {
  ...
  data.forEach((activity) => {
    ...
    <div class="activity__bg ${nameClass}">
          <img src="./images/icon-${activityClass}.svg" alt="briefcase icon" />
        </div>
        <div class="activity__infos">
          <div class="activity__infos--header">
            <h2 class="activity__name">${name}</h2>
            <div class="activity__infos--options">
          ...
          <div class="activity__time">
            ...
            <div class="activity__time--previous">
              <p class="previous__window">${previousTimeFrame}</p>
              <p>&nbsp;-&nbsp;</p>
              <p class="previous__time">${timeFrameData.previous}hrs</p>
            </div>
          </div>
        </div>`;
